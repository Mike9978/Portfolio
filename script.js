...
function sendMessage() {
  ...
  if (name !== '' && email !== '' && phone !== '' && message !== '') {
    ...
    var emailLink = 'mailto:mehulbaria997@gmail.com?subject=Contact%20Form%20Submission&body=Name: ' + encodeURIComponent(name) + '%0D%0AEmail: ' + encodeURIComponent(email) + '%0D%0APhone: ' + encodeURIComponent(phone) + '%0D%0AMessage: ' + encodeURIComponent(message);
